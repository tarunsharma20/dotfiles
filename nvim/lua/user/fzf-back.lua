-- TODO: toggle preview mapping
-- TODO: preview move up and down mapping
...
require'fzf-lua'.setup {
  ...
  files = {
    ...
    rg_opts           = "--color=never --files --hidden --follow -g '!**/{node_modules,dist,lib,.git,.nyc_output,package-lock.json,LICENSES.txt,LICENSES.json}'",
  ...
  grep = {
    ...
    glob_flag         = "--glob",    -- for case insensitive globs use '--iglob'
...
_G.fzf_dirs = function(projects, opts)
...
vim.keymap.set('n', '<leader>m', '<cmd>lua _G.fzf_dirs({"~/workshop/devil", "~/workshop/devil/consumers/app-welcome"})<CR>')
